// Build 142: PixelPlayer installable-app bootstrap with fresh HTML navigations.
(()=>{
  if(window.PixelPlayerPWA142)return;window.PixelPlayerPWA142=true;
  const BUILD=142,head=document.head;
