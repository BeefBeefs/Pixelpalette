// Build 134: PixelPlayer installable-app bootstrap with fresh HTML navigations.
(()=>{
  if(window.PixelPlayerPWA134)return;window.PixelPlayerPWA134=true;
  const BUILD=134,head=document.head;
