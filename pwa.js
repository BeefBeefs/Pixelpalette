// Build 132: PixelPlayer installable-app bootstrap with fresh HTML navigations.
(()=>{
  if(window.PixelPlayerPWA132)return;window.PixelPlayerPWA132=true;
  const BUILD=132,head=document.head;
