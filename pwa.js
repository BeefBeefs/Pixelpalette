// Build 129: PixelPlayer installable-app bootstrap with fresh HTML navigations.
(()=>{
  if(window.PixelPlayerPWA129)return;window.PixelPlayerPWA129=true;
  const BUILD=129,head=document.head;
