// Build 45: only one PixelPlayer emulator runtime may remain active across browser tabs.
(() => {
  ...
  // Load shared navigation, core selector, and low-memory control on every emulator page.
  if(!document.querySelector('script[src*="nav.js"]')){const s=document.createElement('script');s.src='nav.js?v=45';s.defer=true;document.body.appendChild(s);}
